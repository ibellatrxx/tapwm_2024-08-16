...
export default function AtualizaProduto({carregaProdutos, produto}){
    return(
        <div className='card'>
            ...
            <form>
                <label>Nome:</label>
                <input type='text' id='nome' name='nome' value={produto.nome}></input>
                <br/>
                <label>Preço:</label>
                <input type='text' id='preco' name='preco' value={produto.preco}></input>
                <br/>
                <label>Foto:</label>
                ...
                <button type='button' onClick={AtualizaProduto}>Adicionar</button>
            </form>
        </div>
    );
